package com.mapbox.storelocator.util;//package com.mapbox.storelocator;
...
public class MapActivity extends AppCompatActivity implements
    ...
    private static final LatLngBounds LOCKED_MAP_CAMERA_BOUNDS = new LatLngBounds.Builder()
            .include(new LatLng(39.87096725853152, -121.08277394720501))
            .include(new LatLng(39.67035340371385,
                    -121.87063900287112)).build();
    private static final LatLng MOCK_DEVICE_LOCATION_LAT_LNG = new LatLng(39.7286111, -121.8363889);
        ...
        private void initializeTheme() {
            switch (selectedTheme) {
                case R.style.AppTheme_Blue:
                    ...
                    unselectedMarkerIcon = BitmapFactory.decodeResource(context.getResources(), R.drawable.shoppingcart);
                    selectedMarkerIcon = BitmapFactory.decodeResource(context.getResources(), R.drawable.shoppingcart);
